<form action="./repuloterWebFajlok/repulojegyListaWeb.php" method="POST">
      <ul id="inputokSzuroIndexUL">
        <li >      
          <select name="honnan" id="honnan" class="inputokSzuro">
        ...
        <li>      
          <select name="hova" id="hova" class="inputokSzuro">
        ...
        <li>
          <select name="milyenRepuloTarsasagnal" id="milyenRepuloTarsasagnal" class="inputokSzuro">
        ...
        <li>
        <select name="milyenTipusuRepulovel" id="milyenTipusuRepulovel" class="inputokSzuro">
